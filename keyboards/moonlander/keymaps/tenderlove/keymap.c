...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  CTL_T(KC_EQL), KC_A,    KC_S,    KC_E,    KC_T,    KC_G,    KC_MINS,           LSFT(KC_SCLN),    KC_Y,    KC_N,    KC_I,    KC_O,    KC_H,     KC_QUOT,
   ...
   LT(SYMB,KC_GRV),MO(MDIA),A(KC_LSFT),KC_LALT, LGUI_T(KC_ENT), LALT_T(KC_APP),   RCTL_T(KC_ESC),   LGUI_T(KC_BSPACE),   KC_RALT, KC_LBRC, KC_RBRC, TT(SYMB),
                                            KC_SPC,  KC_ENT, KC_END,            LGUI(KC_LBRC), LGUI(KC_RBRC), CTL_T(KC_ESC)
    ),
