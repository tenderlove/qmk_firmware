 ...
 */
[_NORMAN] = {
  {LT(_MOUSE,KC_TAB),KC_Q,    KC_W,    KC_D,    KC_F,          KC_K,    KC_J,    KC_U,          KC_R,    KC_L,    KC_SCLN, KC_BSPC},
 ...
 */
[_SYMB] = {
  {_______, KC_EXLM,    KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE, KC_UP,   KC_7,    KC_8,   KC_9,  KC_ASTR, KC_LEFT},
